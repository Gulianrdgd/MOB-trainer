<script lang="ts">
	...
	const steps: Step[] = [
		...
		},
		{
			...
			text: 'Op een onverwacht moment gaat er iemand overboord en loopt de tijd. Heb je "Zelf starten" gekozen, dan druk je zelf op M of de MOB-knop. Vaar terug en kom langzamer dan 1,5 knoop naast de drenkeling. De groene stippellijn toont de ideale koers.'
		}
	];
